...
<main class="main">
  <div class="chat-header">
    ...
    <div class="ai-profile-pic">
      <img src="{{ asset('assets/reza-avatar.png') }}" style="width:100%;height:100%;object-fit:cover;"/>
    </div>
    <div>
      <div class="ai-name">Kak Reza</div>
      <div class="ai-status">Siap jadi mentor kamu.</div>
    </div>
  ...
  <div class="messages" id="messages">
      @foreach($history as $msg)
        ...
        <div class="msg-row ai">
          <div class="msg-avatar"><img src="{{ asset('assets/reza-avatar.png') }}" style="width:100%;height:100%;object-fit:cover;border-radius:50%;"/></div>
          <div class="msg-group">
  ...
  <div class="input-bar">
    <div class="input-wrap">
      <input type="text" id="chat-input" placeholder="Ketik pesan kamu di sini..." autocomplete="off" />
    </div>
...
<script>
  ...
  function appendMessage(text, sender) {
    ...
    if (sender === 'ai') {
      row.innerHTML = `<div class="msg-avatar"><img src="{{ asset('assets/reza-avatar.png') }}" style="width:100%;height:100%;object-fit:cover;border-radius:50%;"/></div>
        <div class="msg-group">
